...
public class MyConfig1TestWithoutTestProperties {
    ...
    public void testPropertySources(){
        ...
        Assert.assertEquals(stringsFromValueAnnotations,"mycompo1 str1 mycompo1 str2");
    }
    @Test
    public void getMyCompo1Strings() {
        Assert.assertEquals(myCompo1.getMyCompo1Strings(),"mycompo1 str1 mycompo1 str2");
    }
    @Test
